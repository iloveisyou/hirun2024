Rui.namespace('Rui.message.locale.en_KR');
Rui.applyObject(Rui.message.locale.en_KR, {
    locale: 'en_KR',
    core: {
    ...
    base: {
        ...
        msg138: 'Average',
        msg139: 'Calculation',
        msg140: 'The clipboard data has been applied.',
        msg141: 'Copied the data to the clipboard.'
...
var configLocale = Rui.message.locale.en_KR.core;

Rui.util.LDateLocale['en_KR'] = Rui.merge(Rui.util.LDateLocale['ko_KR'], {
...
Rui.message.locale.en_KR.moneyFormat = function(v) {
    return Rui.util.LNumber.toMoney(v, '$');
};

Rui.message.locale.en_KR.numberFormat = function(v) {
