...
Rui.extend(Rui.ui.LFocusNotification, Rui.ui.LNotification, {
    ...
    /**
     * 메시지 창을 숨긴다. LFocusNotification은 hide시 자신의 객체를 destory 한다.
     * @method hide
     */
    hide: function(){
    ...
    /**
     * @description skip click Event
     * @private
     * @method: onClickButtonSkip
     * @param {e} event object
     * @return {void}
     */
